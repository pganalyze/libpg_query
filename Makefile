...
ifeq ($(USE_PROTOBUF_CPP),1)
	...
	override TEST_LDFLAGS += `pkg-config --libs protobuf` -lstdc++ -labsl_log_internal_check_op -labsl_log_internal_message -labsl_raw_logging_internal -labsl_spinlock_wait -lm
