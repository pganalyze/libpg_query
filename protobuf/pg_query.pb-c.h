...
typedef struct PgQuery__PLpgSQLParseResult PgQuery__PLpgSQLParseResult;
typedef struct PgQuery__PLpgSQLStmt PgQuery__PLpgSQLStmt;
typedef struct PgQuery__PLpgSQLDatum PgQuery__PLpgSQLDatum;
typedef struct PgQuery__PLpgSQLType PgQuery__PLpgSQLType;
typedef struct PgQuery__PLpgSQLExpr PgQuery__PLpgSQLExpr;
typedef struct PgQuery__PLpgSQLVar PgQuery__PLpgSQLVar;
typedef struct PgQuery__PLpgSQLRow PgQuery__PLpgSQLRow;
typedef struct PgQuery__PLpgSQLRec PgQuery__PLpgSQLRec;
typedef struct PgQuery__PLpgSQLRecfield PgQuery__PLpgSQLRecfield;
typedef struct PgQuery__PLpgSQLCondition PgQuery__PLpgSQLCondition;
typedef struct PgQuery__PLpgSQLExceptionBlock PgQuery__PLpgSQLExceptionBlock;
typedef struct PgQuery__PLpgSQLException PgQuery__PLpgSQLException;
typedef struct PgQuery__PLpgSQLStmtBlock PgQuery__PLpgSQLStmtBlock;
typedef struct PgQuery__PLpgSQLStmtAssign PgQuery__PLpgSQLStmtAssign;
typedef struct PgQuery__PLpgSQLStmtPerform PgQuery__PLpgSQLStmtPerform;
typedef struct PgQuery__PLpgSQLStmtCall PgQuery__PLpgSQLStmtCall;
typedef struct PgQuery__PLpgSQLStmtCommit PgQuery__PLpgSQLStmtCommit;
typedef struct PgQuery__PLpgSQLStmtRollback PgQuery__PLpgSQLStmtRollback;
typedef struct PgQuery__PLpgSQLDiagItem PgQuery__PLpgSQLDiagItem;
typedef struct PgQuery__PLpgSQLStmtGetdiag PgQuery__PLpgSQLStmtGetdiag;
typedef struct PgQuery__PLpgSQLStmtIf PgQuery__PLpgSQLStmtIf;
typedef struct PgQuery__PLpgSQLIfElsif PgQuery__PLpgSQLIfElsif;
typedef struct PgQuery__PLpgSQLStmtCase PgQuery__PLpgSQLStmtCase;
typedef struct PgQuery__PLpgSQLCaseWhen PgQuery__PLpgSQLCaseWhen;
typedef struct PgQuery__PLpgSQLStmtLoop PgQuery__PLpgSQLStmtLoop;
typedef struct PgQuery__PLpgSQLStmtWhile PgQuery__PLpgSQLStmtWhile;
typedef struct PgQuery__PLpgSQLStmtFori PgQuery__PLpgSQLStmtFori;
typedef struct PgQuery__PLpgSQLStmtFors PgQuery__PLpgSQLStmtFors;
typedef struct PgQuery__PLpgSQLStmtForc PgQuery__PLpgSQLStmtForc;
typedef struct PgQuery__PLpgSQLStmtDynfors PgQuery__PLpgSQLStmtDynfors;
typedef struct PgQuery__PLpgSQLStmtForeachA PgQuery__PLpgSQLStmtForeachA;
typedef struct PgQuery__PLpgSQLStmtOpen PgQuery__PLpgSQLStmtOpen;
typedef struct PgQuery__PLpgSQLStmtFetch PgQuery__PLpgSQLStmtFetch;
typedef struct PgQuery__PLpgSQLStmtClose PgQuery__PLpgSQLStmtClose;
typedef struct PgQuery__PLpgSQLStmtExit PgQuery__PLpgSQLStmtExit;
typedef struct PgQuery__PLpgSQLStmtReturn PgQuery__PLpgSQLStmtReturn;
typedef struct PgQuery__PLpgSQLStmtReturnNext PgQuery__PLpgSQLStmtReturnNext;
typedef struct PgQuery__PLpgSQLStmtReturnQuery PgQuery__PLpgSQLStmtReturnQuery;
typedef struct PgQuery__PLpgSQLStmtRaise PgQuery__PLpgSQLStmtRaise;
typedef struct PgQuery__PLpgSQLRaiseOption PgQuery__PLpgSQLRaiseOption;
typedef struct PgQuery__PLpgSQLStmtAssert PgQuery__PLpgSQLStmtAssert;
typedef struct PgQuery__PLpgSQLStmtExecsql PgQuery__PLpgSQLStmtExecsql;
typedef struct PgQuery__PLpgSQLStmtDynexecute PgQuery__PLpgSQLStmtDynexecute;
typedef struct PgQuery__PLpgSQLFunction PgQuery__PLpgSQLFunction;
...
typedef enum _PgQuery__PLpgSQLNsitemType {
  PG_QUERY__PLPG_SQL_NSITEM_TYPE__P__LPG_SQL_NSITEM_TYPE_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_NSITEM_TYPE__PLPGSQL_NSTYPE_LABEL = 1,
  PG_QUERY__PLPG_SQL_NSITEM_TYPE__PLPGSQL_NSTYPE_VAR = 2,
  PG_QUERY__PLPG_SQL_NSITEM_TYPE__PLPGSQL_NSTYPE_REC = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_NSITEM_TYPE)
} PgQuery__PLpgSQLNsitemType;
typedef enum _PgQuery__PLpgSQLLabelType {
  PG_QUERY__PLPG_SQL_LABEL_TYPE__P__LPG_SQL_LABEL_TYPE_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_LABEL_TYPE__PLPGSQL_LABEL_BLOCK = 1,
  PG_QUERY__PLPG_SQL_LABEL_TYPE__PLPGSQL_LABEL_LOOP = 2,
  PG_QUERY__PLPG_SQL_LABEL_TYPE__PLPGSQL_LABEL_OTHER = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_LABEL_TYPE)
} PgQuery__PLpgSQLLabelType;
typedef enum _PgQuery__PLpgSQLDatumType {
  PG_QUERY__PLPG_SQL_DATUM_TYPE__P__LPG_SQL_DATUM_TYPE_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_DATUM_TYPE__PLPGSQL_DTYPE_VAR = 1,
  PG_QUERY__PLPG_SQL_DATUM_TYPE__PLPGSQL_DTYPE_ROW = 2,
  PG_QUERY__PLPG_SQL_DATUM_TYPE__PLPGSQL_DTYPE_REC = 3,
  PG_QUERY__PLPG_SQL_DATUM_TYPE__PLPGSQL_DTYPE_RECFIELD = 4,
  PG_QUERY__PLPG_SQL_DATUM_TYPE__PLPGSQL_DTYPE_PROMISE = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_DATUM_TYPE)
} PgQuery__PLpgSQLDatumType;
typedef enum _PgQuery__PLpgSQLPromiseType {
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__P__LPG_SQL_PROMISE_TYPE_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_NONE = 1,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_NAME = 2,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_WHEN = 3,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_LEVEL = 4,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_OP = 5,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_RELID = 6,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_TABLE_NAME = 7,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_TABLE_SCHEMA = 8,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_NARGS = 9,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_ARGV = 10,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_EVENT = 11,
  PG_QUERY__PLPG_SQL_PROMISE_TYPE__PLPGSQL_PROMISE_TG_TAG = 12
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_PROMISE_TYPE)
} PgQuery__PLpgSQLPromiseType;
typedef enum _PgQuery__PLpgSQLTypeType {
  PG_QUERY__PLPG_SQL_TYPE_TYPE__P__LPG_SQL_TYPE_TYPE_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_TYPE_TYPE__PLPGSQL_TTYPE_SCALAR = 1,
  PG_QUERY__PLPG_SQL_TYPE_TYPE__PLPGSQL_TTYPE_REC = 2,
  PG_QUERY__PLPG_SQL_TYPE_TYPE__PLPGSQL_TTYPE_PSEUDO = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_TYPE_TYPE)
} PgQuery__PLpgSQLTypeType;
typedef enum _PgQuery__PLpgSQLStmtType {
  PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_BLOCK = 1,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_ASSIGN = 2,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_IF = 3,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_CASE = 4,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_LOOP = 5,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_WHILE = 6,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_FORI = 7,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_FORS = 8,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_FORC = 9,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_FOREACH_A = 10,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_EXIT = 11,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_RETURN = 12,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_RETURN_NEXT = 13,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_RETURN_QUERY = 14,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_RAISE = 15,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_ASSERT = 16,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_EXECSQL = 17,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_DYNEXECUTE = 18,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_DYNFORS = 19,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_GETDIAG = 20,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_OPEN = 21,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_FETCH = 22,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_CLOSE = 23,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_PERFORM = 24,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_CALL = 25,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_COMMIT = 26,
  PG_QUERY__PLPG_SQL_STMT_TYPE__PLPGSQL_STMT_ROLLBACK = 27
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_STMT_TYPE)
} PgQuery__PLpgSQLStmtType;
typedef enum _PgQuery__PLpgSQLGetdiagKind {
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__P__LPG_SQL_GETDIAG_KIND_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_ROW_COUNT = 1,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_ROUTINE_OID = 2,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_CONTEXT = 3,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_ERROR_CONTEXT = 4,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_ERROR_DETAIL = 5,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_ERROR_HINT = 6,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_RETURNED_SQLSTATE = 7,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_COLUMN_NAME = 8,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_CONSTRAINT_NAME = 9,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_DATATYPE_NAME = 10,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_MESSAGE_TEXT = 11,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_TABLE_NAME = 12,
  PG_QUERY__PLPG_SQL_GETDIAG_KIND__PLPGSQL_GETDIAG_SCHEMA_NAME = 13
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_GETDIAG_KIND)
} PgQuery__PLpgSQLGetdiagKind;
typedef enum _PgQuery__PLpgSQLRaiseOptionType {
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__P__LPG_SQL_RAISE_OPTION_TYPE_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_ERRCODE = 1,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_MESSAGE = 2,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_DETAIL = 3,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_HINT = 4,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_COLUMN = 5,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_CONSTRAINT = 6,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_DATATYPE = 7,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_TABLE = 8,
  PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__PLPGSQL_RAISEOPTION_SCHEMA = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE)
} PgQuery__PLpgSQLRaiseOptionType;
typedef enum _PgQuery__PLpgSQLResolveOption {
  PG_QUERY__PLPG_SQL_RESOLVE_OPTION__P__LPG_SQL_RESOLVE_OPTION_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_RESOLVE_OPTION__PLPGSQL_RESOLVE_ERROR = 1,
  PG_QUERY__PLPG_SQL_RESOLVE_OPTION__PLPGSQL_RESOLVE_VARIABLE = 2,
  PG_QUERY__PLPG_SQL_RESOLVE_OPTION__PLPGSQL_RESOLVE_COLUMN = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_RESOLVE_OPTION)
} PgQuery__PLpgSQLResolveOption;
typedef enum _PgQuery__PLpgSQLTrigtype {
  PG_QUERY__PLPG_SQL_TRIGTYPE__P__LPG_SQL_TRIGTYPE_UNDEFINED = 0,
  PG_QUERY__PLPG_SQL_TRIGTYPE__PLPGSQL_DML_TRIGGER = 1,
  PG_QUERY__PLPG_SQL_TRIGTYPE__PLPGSQL_EVENT_TRIGGER = 2,
  PG_QUERY__PLPG_SQL_TRIGTYPE__PLPGSQL_NOT_TRIGGER = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_TRIGTYPE)
...
struct  PgQuery__PLpgSQLParseResult
{
  ProtobufCMessage base;
  int32_t version;
  size_t n_plpgsql_funcs;
  PgQuery__PLpgSQLFunction **plpgsql_funcs;
};
#define PG_QUERY__PLPG_SQLPARSE_RESULT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sqlparse_result__descriptor) \
, 0, 0,NULL }


typedef enum {
  PG_QUERY__PLPG_SQL_STMT__STMT__NOT_SET = 0,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_BLOCK = 1,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_ASSIGN = 2,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_IF = 3,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_CASE_ = 4,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_LOOP = 5,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_WHILE = 6,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_FORI = 7,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_FORS = 8,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_FORC = 9,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_FOREACH_A = 10,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_EXIT = 11,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_RETURN = 12,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_RETURN_NEXT = 13,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_RETURN_QUERY = 14,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_RAISE = 15,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_ASSERT = 16,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_EXECSQL = 17,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_DYNEXECUTE = 18,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_DYNFORS = 19,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_GETDIAG = 20,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_OPEN = 21,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_FETCH = 22,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_CLOSE = 23,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_PERFORM = 24,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_CALL = 25,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_COMMIT = 26,
  PG_QUERY__PLPG_SQL_STMT__STMT_STMT_ROLLBACK = 27
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_STMT__STMT__CASE)
} PgQuery__PLpgSQLStmt__StmtCase;

/*
 * PLpgSQL statement wrapper with oneof for polymorphism
 */
struct  PgQuery__PLpgSQLStmt
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmt__StmtCase stmt_case;
  union {
    PgQuery__PLpgSQLStmtAssert *stmt_assert;
    PgQuery__PLpgSQLStmtAssign *stmt_assign;
    PgQuery__PLpgSQLStmtBlock *stmt_block;
    PgQuery__PLpgSQLStmtCall *stmt_call;
    PgQuery__PLpgSQLStmtCase *stmt_case_;
    PgQuery__PLpgSQLStmtClose *stmt_close;
    PgQuery__PLpgSQLStmtCommit *stmt_commit;
    PgQuery__PLpgSQLStmtDynexecute *stmt_dynexecute;
    PgQuery__PLpgSQLStmtDynfors *stmt_dynfors;
    PgQuery__PLpgSQLStmtExecsql *stmt_execsql;
    PgQuery__PLpgSQLStmtExit *stmt_exit;
    PgQuery__PLpgSQLStmtFetch *stmt_fetch;
    PgQuery__PLpgSQLStmtForc *stmt_forc;
    PgQuery__PLpgSQLStmtForeachA *stmt_foreach_a;
    PgQuery__PLpgSQLStmtFori *stmt_fori;
    PgQuery__PLpgSQLStmtFors *stmt_fors;
    PgQuery__PLpgSQLStmtGetdiag *stmt_getdiag;
    PgQuery__PLpgSQLStmtIf *stmt_if;
    PgQuery__PLpgSQLStmtLoop *stmt_loop;
    PgQuery__PLpgSQLStmtOpen *stmt_open;
    PgQuery__PLpgSQLStmtPerform *stmt_perform;
    PgQuery__PLpgSQLStmtRaise *stmt_raise;
    PgQuery__PLpgSQLStmtReturn *stmt_return;
    PgQuery__PLpgSQLStmtReturnNext *stmt_return_next;
    PgQuery__PLpgSQLStmtReturnQuery *stmt_return_query;
    PgQuery__PLpgSQLStmtRollback *stmt_rollback;
    PgQuery__PLpgSQLStmtWhile *stmt_while;
  };
};
#define PG_QUERY__PLPG_SQL_STMT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt__descriptor) \
, PG_QUERY__PLPG_SQL_STMT__STMT__NOT_SET, {0} }


typedef enum {
  PG_QUERY__PLPG_SQL_DATUM__DATUM__NOT_SET = 0,
  PG_QUERY__PLPG_SQL_DATUM__DATUM_VAR = 1,
  PG_QUERY__PLPG_SQL_DATUM__DATUM_ROW = 3,
  PG_QUERY__PLPG_SQL_DATUM__DATUM_REC = 4,
  PG_QUERY__PLPG_SQL_DATUM__DATUM_RECFIELD = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPG_SQL_DATUM__DATUM__CASE)
} PgQuery__PLpgSQLDatum__DatumCase;

/*
 * PLpgSQL datum wrapper with oneof for polymorphism
 */
struct  PgQuery__PLpgSQLDatum
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLDatum__DatumCase datum_case;
  union {
    PgQuery__PLpgSQLRec *rec;
    PgQuery__PLpgSQLRecfield *recfield;
    PgQuery__PLpgSQLRow *row;
    PgQuery__PLpgSQLVar *var;
  };
};
#define PG_QUERY__PLPG_SQL_DATUM__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_datum__descriptor) \
, PG_QUERY__PLPG_SQL_DATUM__DATUM__NOT_SET, {0} }


struct  PgQuery__PLpgSQLType
{
  ProtobufCMessage base;
  char *typname;
  PgQuery__PLpgSQLTypeType ttype;
};
#define PG_QUERY__PLPG_SQL_TYPE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_type__descriptor) \
, (char *)protobuf_c_empty_string, PG_QUERY__PLPG_SQL_TYPE_TYPE__P__LPG_SQL_TYPE_TYPE_UNDEFINED }


struct  PgQuery__PLpgSQLExpr
{
  ProtobufCMessage base;
  char *query;
  int32_t parse_mode;
};
#define PG_QUERY__PLPG_SQL_EXPR__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_expr__descriptor) \
, (char *)protobuf_c_empty_string, 0 }


struct  PgQuery__PLpgSQLVar
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLDatumType dtype;
  int32_t dno;
  char *refname;
  int32_t lineno;
  protobuf_c_boolean isconst;
  protobuf_c_boolean notnull;
  PgQuery__PLpgSQLExpr *default_val;
  PgQuery__PLpgSQLType *datatype;
  PgQuery__PLpgSQLExpr *cursor_explicit_expr;
  int32_t cursor_explicit_argrow;
  int32_t cursor_options;
  PgQuery__PLpgSQLPromiseType promise;
};
#define PG_QUERY__PLPG_SQL_VAR__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_var__descriptor) \
, PG_QUERY__PLPG_SQL_DATUM_TYPE__P__LPG_SQL_DATUM_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, 0, 0, 0, NULL, NULL, NULL, 0, 0, PG_QUERY__PLPG_SQL_PROMISE_TYPE__P__LPG_SQL_PROMISE_TYPE_UNDEFINED }


struct  PgQuery__PLpgSQLRow
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLDatumType dtype;
  int32_t dno;
...
#define PG_QUERY__PLPG_SQL_ROW__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_row__descriptor) \
, PG_QUERY__PLPG_SQL_DATUM_TYPE__P__LPG_SQL_DATUM_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, 0, 0, 0, NULL, 0 }


struct  PgQuery__PLpgSQLRec
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLDatumType dtype;
  int32_t dno;
...
#define PG_QUERY__PLPG_SQL_REC__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_rec__descriptor) \
, PG_QUERY__PLPG_SQL_DATUM_TYPE__P__LPG_SQL_DATUM_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, 0, 0, 0, NULL, NULL, 0 }


struct  PgQuery__PLpgSQLRecfield
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLDatumType dtype;
  int32_t dno;
...
#define PG_QUERY__PLPG_SQL_RECFIELD__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_recfield__descriptor) \
, PG_QUERY__PLPG_SQL_DATUM_TYPE__P__LPG_SQL_DATUM_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, 0, 0 }
...
#define PG_QUERY__PLPG_SQL_CONDITION__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_condition__descriptor) \
, 0, (char *)protobuf_c_empty_string }


struct  PgQuery__PLpgSQLExceptionBlock
{
  ProtobufCMessage base;
  int32_t sqlstate_varno;
  int32_t sqlerrm_varno;
  size_t n_exc_list;
  PgQuery__PLpgSQLException **exc_list;
};
#define PG_QUERY__PLPG_SQL_EXCEPTION_BLOCK__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_exception_block__descriptor) \
, 0, 0, 0,NULL }
...
struct  PgQuery__PLpgSQLException
{
  ProtobufCMessage base;
  int32_t lineno;
  PgQuery__PLpgSQLCondition *conditions;
  size_t n_action;
  PgQuery__PLpgSQLStmt **action;
};
...
struct  PgQuery__PLpgSQLStmtBlock
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  char *label;
  size_t n_body;
  PgQuery__PLpgSQLStmt **body;
  int32_t n_initvars;
  PgQuery__PLpgSQLExceptionBlock *exceptions;
};
#define PG_QUERY__PLPG_SQL_STMT_BLOCK__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_block__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, 0,NULL, 0, NULL }


struct  PgQuery__PLpgSQLStmtAssign
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  int32_t varno;
  PgQuery__PLpgSQLExpr *expr;
};
#define PG_QUERY__PLPG_SQL_STMT_ASSIGN__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_assign__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, 0, NULL }


struct  PgQuery__PLpgSQLStmtPerform
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_PERFORM__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_perform__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL }


struct  PgQuery__PLpgSQLStmtCall
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  PgQuery__PLpgSQLExpr *expr;
  protobuf_c_boolean is_call;
  PgQuery__PLpgSQLDatum *target;
};
#define PG_QUERY__PLPG_SQL_STMT_CALL__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_call__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, 0, NULL }


struct  PgQuery__PLpgSQLStmtCommit
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_COMMIT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_commit__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, 0 }


struct  PgQuery__PLpgSQLStmtRollback
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_ROLLBACK__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_rollback__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, 0 }


struct  PgQuery__PLpgSQLDiagItem
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLGetdiagKind kind;
  int32_t target;
};
#define PG_QUERY__PLPG_SQL_DIAG_ITEM__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_diag_item__descriptor) \
, PG_QUERY__PLPG_SQL_GETDIAG_KIND__P__LPG_SQL_GETDIAG_KIND_UNDEFINED, 0 }


struct  PgQuery__PLpgSQLStmtGetdiag
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  protobuf_c_boolean is_stacked;
  size_t n_diag_items;
  PgQuery__PLpgSQLDiagItem **diag_items;
};
#define PG_QUERY__PLPG_SQL_STMT_GETDIAG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_getdiag__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, 0, 0,NULL }


struct  PgQuery__PLpgSQLStmtIf
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  PgQuery__PLpgSQLExpr *cond;
  size_t n_then_body;
  PgQuery__PLpgSQLStmt **then_body;
  size_t n_elsif_list;
  PgQuery__PLpgSQLIfElsif **elsif_list;
  size_t n_else_body;
  PgQuery__PLpgSQLStmt **else_body;
};
#define PG_QUERY__PLPG_SQL_STMT_IF__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_if__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, 0,NULL, 0,NULL, 0,NULL }


struct  PgQuery__PLpgSQLIfElsif
{
  ProtobufCMessage base;
  int32_t lineno;
  PgQuery__PLpgSQLExpr *cond;
  size_t n_stmts;
  PgQuery__PLpgSQLStmt **stmts;
};
#define PG_QUERY__PLPG_SQL_IF_ELSIF__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_if_elsif__descriptor) \
, 0, NULL, 0,NULL }


struct  PgQuery__PLpgSQLStmtCase
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  PgQuery__PLpgSQLExpr *t_expr;
  int32_t t_varno;
  size_t n_case_when_list;
  PgQuery__PLpgSQLCaseWhen **case_when_list;
  protobuf_c_boolean have_else;
  size_t n_else_stmts;
  PgQuery__PLpgSQLStmt **else_stmts;
};
#define PG_QUERY__PLPG_SQL_STMT_CASE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_case__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, 0, 0,NULL, 0, 0,NULL }


struct  PgQuery__PLpgSQLCaseWhen
{
  ProtobufCMessage base;
  int32_t lineno;
  PgQuery__PLpgSQLExpr *expr;
...
#define PG_QUERY__PLPG_SQL_CASE_WHEN__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_case_when__descriptor) \
, 0, NULL, 0,NULL }


struct  PgQuery__PLpgSQLStmtLoop
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_LOOP__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_loop__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, 0,NULL }


struct  PgQuery__PLpgSQLStmtWhile
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_WHILE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_while__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, NULL, 0,NULL }


struct  PgQuery__PLpgSQLStmtFori
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  char *label;
  PgQuery__PLpgSQLVar *var;
  PgQuery__PLpgSQLExpr *lower;
  PgQuery__PLpgSQLExpr *upper;
  PgQuery__PLpgSQLExpr *step;
  int32_t reverse;
  size_t n_body;
  PgQuery__PLpgSQLStmt **body;
};
#define PG_QUERY__PLPG_SQL_STMT_FORI__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_fori__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, NULL, NULL, NULL, NULL, 0, 0,NULL }


struct  PgQuery__PLpgSQLStmtFors
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  char *label;
  PgQuery__PLpgSQLDatum *var;
  size_t n_body;
  PgQuery__PLpgSQLStmt **body;
  PgQuery__PLpgSQLExpr *query;
};
#define PG_QUERY__PLPG_SQL_STMT_FORS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_fors__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, NULL, 0,NULL, NULL }


struct  PgQuery__PLpgSQLStmtForc
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  ...
  PgQuery__PLpgSQLStmt **body;
  int32_t curvar;
  PgQuery__PLpgSQLExpr *argquery;
};
#define PG_QUERY__PLPG_SQL_STMT_FORC__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_forc__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, NULL, 0,NULL, 0, NULL }


struct  PgQuery__PLpgSQLStmtDynfors
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  ...
  PgQuery__PLpgSQLExpr *query;
  size_t n_params;
  PgQuery__PLpgSQLExpr **params;
};
#define PG_QUERY__PLPG_SQL_STMT_DYNFORS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_dynfors__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, NULL, 0,NULL, NULL, 0,NULL }


struct  PgQuery__PLpgSQLStmtForeachA
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_FOREACH_A__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_foreach_a__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, (char *)protobuf_c_empty_string, 0, 0, NULL, 0,NULL }


struct  PgQuery__PLpgSQLStmtOpen
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  ...
  PgQuery__PLpgSQLExpr *argquery;
  PgQuery__PLpgSQLExpr *query;
  PgQuery__PLpgSQLExpr *dynquery;
  size_t n_params;
  PgQuery__PLpgSQLExpr **params;
};
#define PG_QUERY__PLPG_SQL_STMT_OPEN__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_open__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, 0, 0, NULL, NULL, NULL, 0,NULL }


struct  PgQuery__PLpgSQLStmtFetch
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  ...
  int64_t how_many;
  PgQuery__PLpgSQLExpr *expr;
  protobuf_c_boolean is_move;
  protobuf_c_boolean returns_multiple_rows;
};
#define PG_QUERY__PLPG_SQL_STMT_FETCH__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_fetch__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, 0, 0, 0, NULL, 0, 0 }


struct  PgQuery__PLpgSQLStmtClose
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_CLOSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_close__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, 0 }


struct  PgQuery__PLpgSQLStmtExit
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  protobuf_c_boolean is_exit;
  char *label;
  PgQuery__PLpgSQLExpr *cond;
};
#define PG_QUERY__PLPG_SQL_STMT_EXIT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_exit__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, 0, (char *)protobuf_c_empty_string, NULL }


struct  PgQuery__PLpgSQLStmtReturn
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_RETURN__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_return__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, 0 }


struct  PgQuery__PLpgSQLStmtReturnNext
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_RETURN_NEXT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_return_next__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, 0 }


struct  PgQuery__PLpgSQLStmtReturnQuery
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_RETURN_QUERY__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_return_query__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, NULL, 0,NULL }


struct  PgQuery__PLpgSQLStmtRaise
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  ...
  PgQuery__PLpgSQLExpr **params;
  size_t n_options;
  PgQuery__PLpgSQLRaiseOption **options;
};
#define PG_QUERY__PLPG_SQL_STMT_RAISE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_raise__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0,NULL, 0,NULL }


struct  PgQuery__PLpgSQLRaiseOption
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLRaiseOptionType opt_type;
  PgQuery__PLpgSQLExpr *expr;
};
#define PG_QUERY__PLPG_SQL_RAISE_OPTION__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_raise_option__descriptor) \
, PG_QUERY__PLPG_SQL_RAISE_OPTION_TYPE__P__LPG_SQL_RAISE_OPTION_TYPE_UNDEFINED, NULL }
...
#define PG_QUERY__PLPG_SQL_STMT_ASSERT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_assert__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, NULL }


struct  PgQuery__PLpgSQLStmtExecsql
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
  PgQuery__PLpgSQLExpr *sqlstmt;
  protobuf_c_boolean mod_stmt;
  protobuf_c_boolean mod_stmt_set;
  protobuf_c_boolean into;
  protobuf_c_boolean strict;
  PgQuery__PLpgSQLDatum *target;
};
#define PG_QUERY__PLPG_SQL_STMT_EXECSQL__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_execsql__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, 0, 0, 0, 0, NULL }


struct  PgQuery__PLpgSQLStmtDynexecute
{
  ProtobufCMessage base;
  PgQuery__PLpgSQLStmtType cmd_type;
  int32_t lineno;
...
#define PG_QUERY__PLPG_SQL_STMT_DYNEXECUTE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_stmt_dynexecute__descriptor) \
, PG_QUERY__PLPG_SQL_STMT_TYPE__P__LPG_SQL_STMT_TYPE_UNDEFINED, 0, NULL, 0, 0, NULL, 0,NULL }


struct  PgQuery__PLpgSQLFunction
{
  ProtobufCMessage base;
  char *fn_signature;
  PgQuery__PLpgSQLTrigtype fn_is_trigger;
  int32_t out_param_varno;
  int32_t found_varno;
  int32_t new_varno;
  int32_t old_varno;
  PgQuery__PLpgSQLResolveOption resolve_option;
  protobuf_c_boolean print_strict_params;
  int32_t extra_warnings;
  int32_t extra_errors;
  int32_t ndatums;
  PgQuery__PLpgSQLStmtBlock *action;
};
#define PG_QUERY__PLPG_SQL_FUNCTION__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpg_sql_function__descriptor) \
, (char *)protobuf_c_empty_string, PG_QUERY__PLPG_SQL_TRIGTYPE__P__LPG_SQL_TRIGTYPE_UNDEFINED, 0, 0, 0, 0, PG_QUERY__PLPG_SQL_RESOLVE_OPTION__P__LPG_SQL_RESOLVE_OPTION_UNDEFINED, 0, 0, 0, 0, NULL }
...
void   pg_query__summary_result__free_unpacked
                     (PgQuery__SummaryResult *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLParseResult methods */
...
void   pg_query__plpg_sql_rec__free_unpacked
                     (PgQuery__PLpgSQLRec *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLRecfield methods */
...
void   pg_query__plpg_sql_recfield__free_unpacked
                     (PgQuery__PLpgSQLRecfield *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLCondition methods */
...
void   pg_query__plpg_sql_condition__free_unpacked
                     (PgQuery__PLpgSQLCondition *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLExceptionBlock methods */
...
void   pg_query__plpg_sql_exception_block__free_unpacked
                     (PgQuery__PLpgSQLExceptionBlock *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLException methods */
...
void   pg_query__plpg_sql_exception__free_unpacked
                     (PgQuery__PLpgSQLException *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtBlock methods */
...
void   pg_query__plpg_sql_stmt_block__free_unpacked
                     (PgQuery__PLpgSQLStmtBlock *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtAssign methods */
...
void   pg_query__plpg_sql_stmt_assign__free_unpacked
                     (PgQuery__PLpgSQLStmtAssign *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtPerform methods */
...
void   pg_query__plpg_sql_stmt_perform__free_unpacked
                     (PgQuery__PLpgSQLStmtPerform *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtCall methods */
...
void   pg_query__plpg_sql_stmt_call__free_unpacked
                     (PgQuery__PLpgSQLStmtCall *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtCommit methods */
...
void   pg_query__plpg_sql_stmt_commit__free_unpacked
                     (PgQuery__PLpgSQLStmtCommit *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtRollback methods */
...
void   pg_query__plpg_sql_stmt_rollback__free_unpacked
                     (PgQuery__PLpgSQLStmtRollback *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLDiagItem methods */
...
void   pg_query__plpg_sql_diag_item__free_unpacked
                     (PgQuery__PLpgSQLDiagItem *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtGetdiag methods */
...
void   pg_query__plpg_sql_stmt_getdiag__free_unpacked
                     (PgQuery__PLpgSQLStmtGetdiag *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtIf methods */
...
void   pg_query__plpg_sql_stmt_if__free_unpacked
                     (PgQuery__PLpgSQLStmtIf *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLIfElsif methods */
...
void   pg_query__plpg_sql_if_elsif__free_unpacked
                     (PgQuery__PLpgSQLIfElsif *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtCase methods */
...
void   pg_query__plpg_sql_stmt_case__free_unpacked
                     (PgQuery__PLpgSQLStmtCase *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLCaseWhen methods */
...
void   pg_query__plpg_sql_case_when__free_unpacked
                     (PgQuery__PLpgSQLCaseWhen *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtLoop methods */
...
void   pg_query__plpg_sql_stmt_loop__free_unpacked
                     (PgQuery__PLpgSQLStmtLoop *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtWhile methods */
...
void   pg_query__plpg_sql_stmt_while__free_unpacked
                     (PgQuery__PLpgSQLStmtWhile *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtFori methods */
...
void   pg_query__plpg_sql_stmt_fori__free_unpacked
                     (PgQuery__PLpgSQLStmtFori *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtFors methods */
...
void   pg_query__plpg_sql_stmt_fors__free_unpacked
                     (PgQuery__PLpgSQLStmtFors *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtForc methods */
...
void   pg_query__plpg_sql_stmt_forc__free_unpacked
                     (PgQuery__PLpgSQLStmtForc *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtDynfors methods */
...
void   pg_query__plpg_sql_stmt_dynfors__free_unpacked
                     (PgQuery__PLpgSQLStmtDynfors *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtForeachA methods */
...
void   pg_query__plpg_sql_stmt_foreach_a__free_unpacked
                     (PgQuery__PLpgSQLStmtForeachA *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtOpen methods */
...
void   pg_query__plpg_sql_stmt_open__free_unpacked
                     (PgQuery__PLpgSQLStmtOpen *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtFetch methods */
...
void   pg_query__plpg_sql_stmt_fetch__free_unpacked
                     (PgQuery__PLpgSQLStmtFetch *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtClose methods */
...
void   pg_query__plpg_sql_stmt_close__free_unpacked
                     (PgQuery__PLpgSQLStmtClose *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtExit methods */
...
void   pg_query__plpg_sql_stmt_exit__free_unpacked
                     (PgQuery__PLpgSQLStmtExit *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtReturn methods */
...
void   pg_query__plpg_sql_stmt_return__free_unpacked
                     (PgQuery__PLpgSQLStmtReturn *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtReturnNext methods */
...
void   pg_query__plpg_sql_stmt_return_next__free_unpacked
                     (PgQuery__PLpgSQLStmtReturnNext *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtReturnQuery methods */
...
void   pg_query__plpg_sql_stmt_return_query__free_unpacked
                     (PgQuery__PLpgSQLStmtReturnQuery *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtRaise methods */
...
void   pg_query__plpg_sql_stmt_raise__free_unpacked
                     (PgQuery__PLpgSQLStmtRaise *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLRaiseOption methods */
...
void   pg_query__plpg_sql_raise_option__free_unpacked
                     (PgQuery__PLpgSQLRaiseOption *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtAssert methods */
...
void   pg_query__plpg_sql_stmt_assert__free_unpacked
                     (PgQuery__PLpgSQLStmtAssert *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtExecsql methods */
...
void   pg_query__plpg_sql_stmt_execsql__free_unpacked
                     (PgQuery__PLpgSQLStmtExecsql *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLStmtDynexecute methods */
...
void   pg_query__plpg_sql_stmt_dynexecute__free_unpacked
                     (PgQuery__PLpgSQLStmtDynexecute *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PLpgSQLFunction methods */
...
typedef void (*PgQuery__SummaryResult_Closure)
                 (const PgQuery__SummaryResult *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLParseResult_Closure)
                 (const PgQuery__PLpgSQLParseResult *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmt_Closure)
                 (const PgQuery__PLpgSQLStmt *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLDatum_Closure)
                 (const PgQuery__PLpgSQLDatum *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLType_Closure)
                 (const PgQuery__PLpgSQLType *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLExpr_Closure)
                 (const PgQuery__PLpgSQLExpr *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLVar_Closure)
                 (const PgQuery__PLpgSQLVar *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLRow_Closure)
                 (const PgQuery__PLpgSQLRow *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLRec_Closure)
                 (const PgQuery__PLpgSQLRec *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLRecfield_Closure)
                 (const PgQuery__PLpgSQLRecfield *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLCondition_Closure)
                 (const PgQuery__PLpgSQLCondition *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLExceptionBlock_Closure)
                 (const PgQuery__PLpgSQLExceptionBlock *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLException_Closure)
                 (const PgQuery__PLpgSQLException *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtBlock_Closure)
                 (const PgQuery__PLpgSQLStmtBlock *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtAssign_Closure)
                 (const PgQuery__PLpgSQLStmtAssign *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtPerform_Closure)
                 (const PgQuery__PLpgSQLStmtPerform *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtCall_Closure)
                 (const PgQuery__PLpgSQLStmtCall *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtCommit_Closure)
                 (const PgQuery__PLpgSQLStmtCommit *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtRollback_Closure)
                 (const PgQuery__PLpgSQLStmtRollback *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLDiagItem_Closure)
                 (const PgQuery__PLpgSQLDiagItem *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtGetdiag_Closure)
                 (const PgQuery__PLpgSQLStmtGetdiag *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtIf_Closure)
                 (const PgQuery__PLpgSQLStmtIf *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLIfElsif_Closure)
                 (const PgQuery__PLpgSQLIfElsif *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtCase_Closure)
                 (const PgQuery__PLpgSQLStmtCase *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLCaseWhen_Closure)
                 (const PgQuery__PLpgSQLCaseWhen *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtLoop_Closure)
                 (const PgQuery__PLpgSQLStmtLoop *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtWhile_Closure)
                 (const PgQuery__PLpgSQLStmtWhile *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtFori_Closure)
                 (const PgQuery__PLpgSQLStmtFori *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtFors_Closure)
                 (const PgQuery__PLpgSQLStmtFors *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtForc_Closure)
                 (const PgQuery__PLpgSQLStmtForc *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtDynfors_Closure)
                 (const PgQuery__PLpgSQLStmtDynfors *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtForeachA_Closure)
                 (const PgQuery__PLpgSQLStmtForeachA *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtOpen_Closure)
                 (const PgQuery__PLpgSQLStmtOpen *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtFetch_Closure)
                 (const PgQuery__PLpgSQLStmtFetch *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtClose_Closure)
                 (const PgQuery__PLpgSQLStmtClose *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtExit_Closure)
                 (const PgQuery__PLpgSQLStmtExit *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtReturn_Closure)
                 (const PgQuery__PLpgSQLStmtReturn *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtReturnNext_Closure)
                 (const PgQuery__PLpgSQLStmtReturnNext *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtReturnQuery_Closure)
                 (const PgQuery__PLpgSQLStmtReturnQuery *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtRaise_Closure)
                 (const PgQuery__PLpgSQLStmtRaise *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLRaiseOption_Closure)
                 (const PgQuery__PLpgSQLRaiseOption *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtAssert_Closure)
                 (const PgQuery__PLpgSQLStmtAssert *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtExecsql_Closure)
                 (const PgQuery__PLpgSQLStmtExecsql *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLStmtDynexecute_Closure)
                 (const PgQuery__PLpgSQLStmtDynexecute *message,
                  void *closure_data);
typedef void (*PgQuery__PLpgSQLFunction_Closure)
                 (const PgQuery__PLpgSQLFunction *message,
                  void *closure_data);
...
extern const ProtobufCEnumDescriptor    pg_query__plpg_sql_nsitem_type__descriptor;
extern const ProtobufCEnumDescriptor    pg_query__plpg_sql_label_type__descriptor;
extern const ProtobufCEnumDescriptor    pg_query__plpg_sql_datum_type__descriptor;
extern const ProtobufCEnumDescriptor    pg_query__plpg_sql_promise_type__descriptor;
extern const ProtobufCEnumDescriptor    pg_query__plpg_sql_type_type__descriptor;
extern const ProtobufCEnumDescriptor    pg_query__plpg_sql_stmt_type__descriptor;
extern const ProtobufCEnumDescriptor    pg_query__plpg_sql_getdiag_kind__descriptor;
extern const ProtobufCEnumDescriptor    pg_query__plpg_sql_raise_option_type__descriptor;
...
extern const ProtobufCMessageDescriptor pg_query__plpg_sqlparse_result__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_datum__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_type__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_expr__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_var__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_row__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_rec__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_recfield__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_condition__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_exception_block__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_exception__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_block__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_assign__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_perform__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_call__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_commit__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_rollback__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_diag_item__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_getdiag__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_if__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_if_elsif__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_case__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_case_when__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_loop__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_while__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_fori__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_fors__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_forc__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_dynfors__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_foreach_a__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_open__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_fetch__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_close__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_exit__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_return__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_return_next__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_return_query__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_raise__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_raise_option__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_assert__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_execsql__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_stmt_dynexecute__descriptor;
extern const ProtobufCMessageDescriptor pg_query__plpg_sql_function__descriptor;
