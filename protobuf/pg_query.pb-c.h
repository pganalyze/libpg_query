...
typedef struct _PgQuery__PlpgsqlScanToken PgQuery__PlpgsqlScanToken;
...
typedef enum _PgQuery__PlpgsqlToken {
  PG_QUERY__PLPGSQL_TOKEN__PLPG_NUL = 0,
  /*
   * Single-character tokens that are returned 1:1 (identical with "self" list in scan.l)
   * Either supporting syntax, or single-character operators (some can be both)
   * Also see https://www.postgresql.org/docs/12/sql-syntax-lexical.html#SQL-SYNTAX-SPECIAL-CHARS
   ...
   * "%"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_37 = 37,
  /*
   * "("
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_40 = 40,
  /*
   * ")"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_41 = 41,
  /*
   * "*"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_42 = 42,
  /*
   * "+"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_43 = 43,
  /*
   * ","
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_44 = 44,
  /*
   * "-"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_45 = 45,
  /*
   * "."
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_46 = 46,
  /*
   * "/"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_47 = 47,
  /*
   * ":"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_58 = 58,
  /*
   * ";"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_59 = 59,
  /*
   * "<"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_60 = 60,
  /*
   * "="
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_61 = 61,
  /*
   * ">"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_62 = 62,
  /*
   * "?"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_63 = 63,
  /*
   * "["
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_91 = 91,
  /*
   * "\"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_92 = 92,
  /*
   * "]"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_93 = 93,
  /*
   * "^"
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ASCII_94 = 94,
  /*
   * Named tokens in scan.l
   */
  PG_QUERY__PLPGSQL_TOKEN__PLPG_IDENT = 258,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_UIDENT = 259,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_FCONST = 260,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_SCONST = 261,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_USCONST = 262,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_BCONST = 263,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_XCONST = 264,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_Op = 265,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_ICONST = 266,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_PARAM = 267,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_TYPECAST = 268,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_DOT_DOT = 269,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_COLON_EQUALS = 270,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_EQUALS_GREATER = 271,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_LESS_EQUALS = 272,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_GREATER_EQUALS = 273,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_NOT_EQUALS = 274,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_SQL_COMMENT = 275,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_C_COMMENT = 276,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_T_WORD = 277,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_T_CWORD = 278,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_T_DATUM = 279,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_LESS_LESS = 280,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_GREATER_GREATER = 281,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ABSOLUTE = 282,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ALIAS = 283,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ALL = 284,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_AND = 285,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ARRAY = 286,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ASSERT = 287,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_BACKWARD = 288,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_BEGIN = 289,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_BY = 290,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CALL = 291,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CASE = 292,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CHAIN = 293,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CLOSE = 294,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_COLLATE = 295,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_COLUMN = 296,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_COLUMN_NAME = 297,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_COMMIT = 298,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CONSTANT = 299,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CONSTRAINT = 300,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CONSTRAINT_NAME = 301,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CONTINUE = 302,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CURRENT = 303,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_CURSOR = 304,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_DATATYPE = 305,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_DEBUG = 306,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_DECLARE = 307,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_DEFAULT = 308,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_DETAIL = 309,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_DIAGNOSTICS = 310,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_DO = 311,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_DUMP = 312,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ELSE = 313,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ELSIF = 314,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_END = 315,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ERRCODE = 316,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ERROR = 317,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_EXCEPTION = 318,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_EXECUTE = 319,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_EXIT = 320,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_FETCH = 321,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_FIRST = 322,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_FOR = 323,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_FOREACH = 324,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_FORWARD = 325,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_FROM = 326,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_GET = 327,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_HINT = 328,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_IF = 329,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_IMPORT = 330,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_IN = 331,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_INFO = 332,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_INSERT = 333,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_INTO = 334,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_IS = 335,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_LAST = 336,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_LOG = 337,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_LOOP = 338,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_MESSAGE = 339,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_MESSAGE_TEXT = 340,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_MOVE = 341,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_NEXT = 342,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_NO = 343,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_NOT = 344,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_NOTICE = 345,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_NULL = 346,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_OPEN = 347,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_OPTION = 348,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_OR = 349,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_PERFORM = 350,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_PG_CONTEXT = 351,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_PG_DATATYPE_NAME = 352,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_PG_EXCEPTION_CONTEXT = 353,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_PG_EXCEPTION_DETAIL = 354,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_PG_EXCEPTION_HINT = 355,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_PRINT_STRICT_PARAMS = 356,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_PRIOR = 357,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_QUERY = 358,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_RAISE = 359,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_RELATIVE = 360,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_RESET = 361,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_RETURN = 362,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_RETURNED_SQLSTATE = 363,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_REVERSE = 364,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ROLLBACK = 365,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ROW_COUNT = 366,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_ROWTYPE = 367,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_SCHEMA = 368,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_SCHEMA_NAME = 369,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_SCROLL = 370,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_SET = 371,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_SLICE = 372,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_SQLSTATE = 373,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_STACKED = 374,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_STRICT = 375,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_TABLE = 376,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_TABLE_NAME = 377,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_THEN = 378,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_TO = 379,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_TYPE = 380,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_USE_COLUMN = 381,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_USE_VARIABLE = 382,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_USING = 383,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_VARIABLE_CONFLICT = 384,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_WARNING = 385,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_WHEN = 386,
  PG_QUERY__PLPGSQL_TOKEN__PLPG_K_WHILE = 387
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PLPGSQL_TOKEN)
} PgQuery__PlpgsqlToken;
...
struct  _PgQuery__PlpgsqlScanToken
{
  ProtobufCMessage base;
  int32_t start;
  int32_t end;
  PgQuery__PlpgsqlToken token;
  PgQuery__KeywordKind keyword_kind;
};
#define PG_QUERY__PLPGSQL_SCAN_TOKEN__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__plpgsql_scan_token__descriptor) \
    , 0, 0, PG_QUERY__PLPGSQL_TOKEN__PLPG_NUL, PG_QUERY__KEYWORD_KIND__NO_KEYWORD }
...
void   pg_query__scan_token__free_unpacked
                     (PgQuery__ScanToken *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PlpgsqlScanToken methods */
void   pg_query__plpgsql_scan_token__init
                     (PgQuery__PlpgsqlScanToken         *message);
size_t pg_query__plpgsql_scan_token__get_packed_size
                     (const PgQuery__PlpgsqlScanToken   *message);
size_t pg_query__plpgsql_scan_token__pack
                     (const PgQuery__PlpgsqlScanToken   *message,
                      uint8_t             *out);
size_t pg_query__plpgsql_scan_token__pack_to_buffer
                     (const PgQuery__PlpgsqlScanToken   *message,
                      ProtobufCBuffer     *buffer);
PgQuery__PlpgsqlScanToken *
       pg_query__plpgsql_scan_token__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data);
void   pg_query__plpgsql_scan_token__free_unpacked
                     (PgQuery__PlpgsqlScanToken *message,
                      ProtobufCAllocator *allocator);
...
typedef void (*PgQuery__ScanToken_Closure)
                 (const PgQuery__ScanToken *message,
                  void *closure_data);
typedef void (*PgQuery__PlpgsqlScanToken_Closure)
                 (const PgQuery__PlpgsqlScanToken *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor pg_query__plpgsql_scan_token__descriptor;
