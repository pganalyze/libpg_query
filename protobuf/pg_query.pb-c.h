...
typedef struct PgQuery__DistributeBy PgQuery__DistributeBy;
typedef struct PgQuery__PGXCSubCluster PgQuery__PGXCSubCluster;
...
typedef struct PgQuery__PartitionBy PgQuery__PartitionBy;
...
typedef enum _PgQuery__DistributionType {
  PG_QUERY__DISTRIBUTION_TYPE__DISTRIBUTION_TYPE_UNDEFINED = 0,
  PG_QUERY__DISTRIBUTION_TYPE__DISTTYPE_REPLICATION = 1,
  PG_QUERY__DISTRIBUTION_TYPE__DISTTYPE_HASH = 2,
  PG_QUERY__DISTRIBUTION_TYPE__DISTTYPE_ROUNDROBIN = 3,
  PG_QUERY__DISTRIBUTION_TYPE__DISTTYPE_MODULO = 4,
  PG_QUERY__DISTRIBUTION_TYPE__DISTTYPE_SHARD = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__DISTRIBUTION_TYPE)
} PgQuery__DistributionType;
typedef enum _PgQuery__PGXCSubClusterType {
  PG_QUERY__PGXCSUB_CLUSTER_TYPE__PGXCSUB_CLUSTER_TYPE_UNDEFINED = 0,
  PG_QUERY__PGXCSUB_CLUSTER_TYPE__SUBCLUSTER_NONE = 1,
  PG_QUERY__PGXCSUB_CLUSTER_TYPE__SUBCLUSTER_NODE = 2,
  PG_QUERY__PGXCSUB_CLUSTER_TYPE__SUBCLUSTER_GROUP = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__PGXCSUB_CLUSTER_TYPE)
} PgQuery__PGXCSubClusterType;
...
typedef enum _PgQuery__Token {
  ...
  PG_QUERY__TOKEN__DISTKEY = 392,
  PG_QUERY__TOKEN__DISTRIBUTE = 393,
  PG_QUERY__TOKEN__DISTRIBUTED = 394,
  PG_QUERY__TOKEN__DISTSTYLE = 395,
  PG_QUERY__TOKEN__DO = 396,
  PG_QUERY__TOKEN__DOCUMENT_P = 397,
  PG_QUERY__TOKEN__DOMAIN_P = 398,
  PG_QUERY__TOKEN__DOUBLE_P = 399,
  PG_QUERY__TOKEN__DROP = 400,
  PG_QUERY__TOKEN__EACH = 401,
  PG_QUERY__TOKEN__ELSE = 402,
  PG_QUERY__TOKEN__ENABLE_P = 403,
  PG_QUERY__TOKEN__ENCODING = 404,
  PG_QUERY__TOKEN__ENCRYPTED = 405,
  PG_QUERY__TOKEN__END_P = 406,
  PG_QUERY__TOKEN__ENUM_P = 407,
  ...
  PG_QUERY__TOKEN__KEY = 491,
  PG_QUERY__TOKEN__KEYS = 492,
  PG_QUERY__TOKEN__LABEL = 493,
  PG_QUERY__TOKEN__LANGUAGE = 494,
  PG_QUERY__TOKEN__LARGE_P = 495,
  PG_QUERY__TOKEN__LAST_P = 496,
  PG_QUERY__TOKEN__LATERAL_P = 497,
  PG_QUERY__TOKEN__LEADING = 498,
  PG_QUERY__TOKEN__LEAKPROOF = 499,
  PG_QUERY__TOKEN__LEAST = 500,
  PG_QUERY__TOKEN__LEFT = 501,
  PG_QUERY__TOKEN__LEVEL = 502,
  PG_QUERY__TOKEN__LIKE = 503,
  PG_QUERY__TOKEN__LIMIT = 504,
  PG_QUERY__TOKEN__LISTEN = 505,
  PG_QUERY__TOKEN__LOAD = 506,
  PG_QUERY__TOKEN__LOCAL = 507,
  PG_QUERY__TOKEN__LOCALTIME = 508,
  PG_QUERY__TOKEN__LOCALTIMESTAMP = 509,
  PG_QUERY__TOKEN__LOCATION = 510,
  PG_QUERY__TOKEN__LOCK_P = 511,
  PG_QUERY__TOKEN__LOCKED = 512,
  PG_QUERY__TOKEN__LOGGED = 513,
  PG_QUERY__TOKEN__MAPPING = 514,
  PG_QUERY__TOKEN__MATCH = 515,
  PG_QUERY__TOKEN__MATCHED = 516,
  PG_QUERY__TOKEN__MATERIALIZED = 517,
  PG_QUERY__TOKEN__MAXVALUE = 518,
  PG_QUERY__TOKEN__MERGE = 519,
  PG_QUERY__TOKEN__METHOD = 520,
  PG_QUERY__TOKEN__MINUTE_P = 521,
  PG_QUERY__TOKEN__MINVALUE = 522,
  PG_QUERY__TOKEN__MODE = 523,
  PG_QUERY__TOKEN__MONTH_P = 524,
  PG_QUERY__TOKEN__MOVE = 525,
  PG_QUERY__TOKEN__NAME_P = 526,
  PG_QUERY__TOKEN__NAMES = 527,
  PG_QUERY__TOKEN__NATIONAL = 528,
  PG_QUERY__TOKEN__NATURAL = 529,
  PG_QUERY__TOKEN__NCHAR = 530,
  PG_QUERY__TOKEN__NEW = 531,
  PG_QUERY__TOKEN__NEXT = 532,
  PG_QUERY__TOKEN__NFC = 533,
  PG_QUERY__TOKEN__NFD = 534,
  PG_QUERY__TOKEN__NFKC = 535,
  PG_QUERY__TOKEN__NFKD = 536,
  PG_QUERY__TOKEN__NO = 537,
  PG_QUERY__TOKEN__NODE = 538,
  PG_QUERY__TOKEN__NONE = 539,
  PG_QUERY__TOKEN__NORMALIZE = 540,
  PG_QUERY__TOKEN__NORMALIZED = 541,
  PG_QUERY__TOKEN__NOT = 542,
  PG_QUERY__TOKEN__NOTHING = 543,
  PG_QUERY__TOKEN__NOTIFY = 544,
  PG_QUERY__TOKEN__NOTNULL = 545,
  PG_QUERY__TOKEN__NOWAIT = 546,
  PG_QUERY__TOKEN__NULL_P = 547,
  PG_QUERY__TOKEN__NULLIF = 548,
  PG_QUERY__TOKEN__NULLS_P = 549,
  PG_QUERY__TOKEN__NUMERIC = 550,
  PG_QUERY__TOKEN__OBJECT_P = 551,
  PG_QUERY__TOKEN__OF = 552,
  PG_QUERY__TOKEN__OFF = 553,
  PG_QUERY__TOKEN__OFFSET = 554,
  PG_QUERY__TOKEN__OIDS = 555,
  PG_QUERY__TOKEN__OLD = 556,
  PG_QUERY__TOKEN__ON = 557,
  PG_QUERY__TOKEN__ONLY = 558,
  PG_QUERY__TOKEN__OPERATOR = 559,
  PG_QUERY__TOKEN__OPTION = 560,
  PG_QUERY__TOKEN__OPTIONS = 561,
  PG_QUERY__TOKEN__OR = 562,
  PG_QUERY__TOKEN__ORDER = 563,
  PG_QUERY__TOKEN__ORDINALITY = 564,
  PG_QUERY__TOKEN__OTHERS = 565,
  PG_QUERY__TOKEN__OUT_P = 566,
  PG_QUERY__TOKEN__OUTER_P = 567,
  PG_QUERY__TOKEN__OVER = 568,
  PG_QUERY__TOKEN__OVERLAPS = 569,
  PG_QUERY__TOKEN__OVERLAY = 570,
  PG_QUERY__TOKEN__OVERRIDING = 571,
  PG_QUERY__TOKEN__OWNED = 572,
  PG_QUERY__TOKEN__OWNER = 573,
  PG_QUERY__TOKEN__PARALLEL = 574,
  PG_QUERY__TOKEN__PARAMETER = 575,
  PG_QUERY__TOKEN__PARSER = 576,
  PG_QUERY__TOKEN__PARTIAL = 577,
  PG_QUERY__TOKEN__PARTITION = 578,
  PG_QUERY__TOKEN__PARTITIONS = 579,
  PG_QUERY__TOKEN__PASSING = 580,
  PG_QUERY__TOKEN__PASSWORD = 581,
  PG_QUERY__TOKEN__PLACING = 582,
  PG_QUERY__TOKEN__PLANS = 583,
  PG_QUERY__TOKEN__POLICY = 584,
  PG_QUERY__TOKEN__POSITION = 585,
  PG_QUERY__TOKEN__PRECEDING = 586,
  PG_QUERY__TOKEN__PRECISION = 587,
  PG_QUERY__TOKEN__PRESERVE = 588,
  PG_QUERY__TOKEN__PREPARE = 589,
  PG_QUERY__TOKEN__PREPARED = 590,
  PG_QUERY__TOKEN__PRIMARY = 591,
  PG_QUERY__TOKEN__PRIOR = 592,
  PG_QUERY__TOKEN__PRIVILEGES = 593,
  PG_QUERY__TOKEN__PROCEDURAL = 594,
  PG_QUERY__TOKEN__PROCEDURE = 595,
  PG_QUERY__TOKEN__PROCEDURES = 596,
  PG_QUERY__TOKEN__PROGRAM = 597,
  PG_QUERY__TOKEN__PUBLICATION = 598,
  PG_QUERY__TOKEN__QUOTE = 599,
  PG_QUERY__TOKEN__RANDOMLY = 600,
  PG_QUERY__TOKEN__RANGE = 601,
  PG_QUERY__TOKEN__READ = 602,
  PG_QUERY__TOKEN__REAL = 603,
  PG_QUERY__TOKEN__REASSIGN = 604,
  PG_QUERY__TOKEN__RECHECK = 605,
  PG_QUERY__TOKEN__RECURSIVE = 606,
  PG_QUERY__TOKEN__REF_P = 607,
  PG_QUERY__TOKEN__REFERENCES = 608,
  PG_QUERY__TOKEN__REFERENCING = 609,
  PG_QUERY__TOKEN__REFRESH = 610,
  PG_QUERY__TOKEN__REINDEX = 611,
  PG_QUERY__TOKEN__RELATIVE_P = 612,
  PG_QUERY__TOKEN__RELEASE = 613,
  PG_QUERY__TOKEN__RENAME = 614,
  PG_QUERY__TOKEN__REPEATABLE = 615,
  PG_QUERY__TOKEN__REPLACE = 616,
  PG_QUERY__TOKEN__REPLICA = 617,
  PG_QUERY__TOKEN__RESET = 618,
  PG_QUERY__TOKEN__RESTART = 619,
  PG_QUERY__TOKEN__RESTRICT = 620,
  PG_QUERY__TOKEN__RETURN = 621,
  PG_QUERY__TOKEN__RETURNING = 622,
  PG_QUERY__TOKEN__RETURNS = 623,
  PG_QUERY__TOKEN__REVOKE = 624,
  PG_QUERY__TOKEN__RIGHT = 625,
  PG_QUERY__TOKEN__ROLE = 626,
  PG_QUERY__TOKEN__ROLLBACK = 627,
  PG_QUERY__TOKEN__ROLLUP = 628,
  PG_QUERY__TOKEN__ROUTINE = 629,
  PG_QUERY__TOKEN__ROUTINES = 630,
  PG_QUERY__TOKEN__ROW = 631,
  PG_QUERY__TOKEN__ROWS = 632,
  PG_QUERY__TOKEN__RULE = 633,
  PG_QUERY__TOKEN__SAVEPOINT = 634,
  PG_QUERY__TOKEN__SCALAR = 635,
  PG_QUERY__TOKEN__SCHEMA = 636,
  PG_QUERY__TOKEN__SCHEMAS = 637,
  PG_QUERY__TOKEN__SCROLL = 638,
  PG_QUERY__TOKEN__SEARCH = 639,
  PG_QUERY__TOKEN__SECOND_P = 640,
  PG_QUERY__TOKEN__SECURITY = 641,
  PG_QUERY__TOKEN__SELECT = 642,
  PG_QUERY__TOKEN__SEQUENCE = 643,
  PG_QUERY__TOKEN__SEQUENCES = 644,
  PG_QUERY__TOKEN__SERIALIZABLE = 645,
  PG_QUERY__TOKEN__SERVER = 646,
  PG_QUERY__TOKEN__SESSION = 647,
  PG_QUERY__TOKEN__SESSION_USER = 648,
  PG_QUERY__TOKEN__SET = 649,
  PG_QUERY__TOKEN__SETS = 650,
  PG_QUERY__TOKEN__SETOF = 651,
  PG_QUERY__TOKEN__SHARE = 652,
  PG_QUERY__TOKEN__SHOW = 653,
  PG_QUERY__TOKEN__SIMILAR = 654,
  PG_QUERY__TOKEN__SIMPLE = 655,
  PG_QUERY__TOKEN__SKIP = 656,
  PG_QUERY__TOKEN__SMALLINT = 657,
  PG_QUERY__TOKEN__SNAPSHOT = 658,
  PG_QUERY__TOKEN__SOME = 659,
  PG_QUERY__TOKEN__SQL_P = 660,
  PG_QUERY__TOKEN__STABLE = 661,
  PG_QUERY__TOKEN__STANDALONE_P = 662,
  PG_QUERY__TOKEN__START = 663,
  PG_QUERY__TOKEN__STATEMENT = 664,
  PG_QUERY__TOKEN__STATISTICS = 665,
  PG_QUERY__TOKEN__STDIN = 666,
  PG_QUERY__TOKEN__STDOUT = 667,
  PG_QUERY__TOKEN__STEP = 668,
  PG_QUERY__TOKEN__STORAGE = 669,
  PG_QUERY__TOKEN__STORED = 670,
  PG_QUERY__TOKEN__STRICT_P = 671,
  PG_QUERY__TOKEN__STRIP_P = 672,
  PG_QUERY__TOKEN__SUBSCRIPTION = 673,
  PG_QUERY__TOKEN__SUBSTRING = 674,
  PG_QUERY__TOKEN__SUPPORT = 675,
  PG_QUERY__TOKEN__SYMMETRIC = 676,
  PG_QUERY__TOKEN__SYSID = 677,
  PG_QUERY__TOKEN__SYSTEM_P = 678,
  PG_QUERY__TOKEN__SYSTEM_USER = 679,
  PG_QUERY__TOKEN__TABLE = 680,
  PG_QUERY__TOKEN__TABLES = 681,
  PG_QUERY__TOKEN__TABLESAMPLE = 682,
  PG_QUERY__TOKEN__TABLESPACE = 683,
  PG_QUERY__TOKEN__TEMP = 684,
  PG_QUERY__TOKEN__TEMPLATE = 685,
  PG_QUERY__TOKEN__TEMPORARY = 686,
  PG_QUERY__TOKEN__TEXT_P = 687,
  PG_QUERY__TOKEN__THEN = 688,
  PG_QUERY__TOKEN__TIES = 689,
  PG_QUERY__TOKEN__TIME = 690,
  PG_QUERY__TOKEN__TIMESTAMP = 691,
  PG_QUERY__TOKEN__TO = 692,
  PG_QUERY__TOKEN__TRAILING = 693,
  PG_QUERY__TOKEN__TRANSACTION = 694,
  PG_QUERY__TOKEN__TRANSFORM = 695,
  PG_QUERY__TOKEN__TREAT = 696,
  PG_QUERY__TOKEN__TRIGGER = 697,
  PG_QUERY__TOKEN__TRIM = 698,
  PG_QUERY__TOKEN__TRUE_P = 699,
  PG_QUERY__TOKEN__TRUNCATE = 700,
  PG_QUERY__TOKEN__TRUSTED = 701,
  PG_QUERY__TOKEN__TYPE_P = 702,
  PG_QUERY__TOKEN__TYPES_P = 703,
  PG_QUERY__TOKEN__UESCAPE = 704,
  PG_QUERY__TOKEN__UNBOUNDED = 705,
  PG_QUERY__TOKEN__UNCOMMITTED = 706,
  PG_QUERY__TOKEN__UNENCRYPTED = 707,
  PG_QUERY__TOKEN__UNION = 708,
  PG_QUERY__TOKEN__UNIQUE = 709,
  PG_QUERY__TOKEN__UNKNOWN = 710,
  PG_QUERY__TOKEN__UNLISTEN = 711,
  PG_QUERY__TOKEN__UNLOGGED = 712,
  PG_QUERY__TOKEN__UNTIL = 713,
  PG_QUERY__TOKEN__UPDATE = 714,
  PG_QUERY__TOKEN__USER = 715,
  PG_QUERY__TOKEN__USING = 716,
  PG_QUERY__TOKEN__VACUUM = 717,
  PG_QUERY__TOKEN__VALID = 718,
  PG_QUERY__TOKEN__VALIDATE = 719,
  PG_QUERY__TOKEN__VALIDATOR = 720,
  PG_QUERY__TOKEN__VALUE_P = 721,
  PG_QUERY__TOKEN__VALUES = 722,
  PG_QUERY__TOKEN__VARCHAR = 723,
  PG_QUERY__TOKEN__VARIADIC = 724,
  PG_QUERY__TOKEN__VARYING = 725,
  PG_QUERY__TOKEN__VERBOSE = 726,
  PG_QUERY__TOKEN__VERSION_P = 727,
  PG_QUERY__TOKEN__VIEW = 728,
  PG_QUERY__TOKEN__VIEWS = 729,
  PG_QUERY__TOKEN__VOLATILE = 730,
  PG_QUERY__TOKEN__WHEN = 731,
  PG_QUERY__TOKEN__WHERE = 732,
  PG_QUERY__TOKEN__WHITESPACE_P = 733,
  PG_QUERY__TOKEN__WINDOW = 734,
  PG_QUERY__TOKEN__WITH = 735,
  PG_QUERY__TOKEN__WITHIN = 736,
  PG_QUERY__TOKEN__WITHOUT = 737,
  PG_QUERY__TOKEN__WORK = 738,
  PG_QUERY__TOKEN__WRAPPER = 739,
  PG_QUERY__TOKEN__WRITE = 740,
  PG_QUERY__TOKEN__XML_P = 741,
  PG_QUERY__TOKEN__XMLATTRIBUTES = 742,
  PG_QUERY__TOKEN__XMLCONCAT = 743,
  PG_QUERY__TOKEN__XMLELEMENT = 744,
  PG_QUERY__TOKEN__XMLEXISTS = 745,
  PG_QUERY__TOKEN__XMLFOREST = 746,
  PG_QUERY__TOKEN__XMLNAMESPACES = 747,
  PG_QUERY__TOKEN__XMLPARSE = 748,
  PG_QUERY__TOKEN__XMLPI = 749,
  PG_QUERY__TOKEN__XMLROOT = 750,
  PG_QUERY__TOKEN__XMLSERIALIZE = 751,
  PG_QUERY__TOKEN__XMLTABLE = 752,
  PG_QUERY__TOKEN__YEAR_P = 753,
  PG_QUERY__TOKEN__YES_P = 754,
  PG_QUERY__TOKEN__ZONE = 755,
  PG_QUERY__TOKEN__FORMAT_LA = 756,
  PG_QUERY__TOKEN__NOT_LA = 757,
  PG_QUERY__TOKEN__NULLS_LA = 758,
  PG_QUERY__TOKEN__WITH_LA = 759,
  PG_QUERY__TOKEN__WITHOUT_LA = 760,
  PG_QUERY__TOKEN__MODE_TYPE_NAME = 761,
  PG_QUERY__TOKEN__MODE_PLPGSQL_EXPR = 762,
  PG_QUERY__TOKEN__MODE_PLPGSQL_ASSIGN1 = 763,
  PG_QUERY__TOKEN__MODE_PLPGSQL_ASSIGN2 = 764,
  PG_QUERY__TOKEN__MODE_PLPGSQL_ASSIGN3 = 765,
  PG_QUERY__TOKEN__UMINUS = 766
...
typedef enum {
  ...
  PG_QUERY__NODE__NODE_DISTRIBUTE_BY = 55,
  PG_QUERY__NODE__NODE_PGXCSUB_CLUSTER = 56,
  PG_QUERY__NODE__NODE_ON_CONFLICT_EXPR = 57,
  PG_QUERY__NODE__NODE_QUERY = 58,
  PG_QUERY__NODE__NODE_TYPE_NAME = 59,
  PG_QUERY__NODE__NODE_COLUMN_REF = 60,
  PG_QUERY__NODE__NODE_PARAM_REF = 61,
  PG_QUERY__NODE__NODE_A_EXPR = 62,
  PG_QUERY__NODE__NODE_TYPE_CAST = 63,
  PG_QUERY__NODE__NODE_COLLATE_CLAUSE = 64,
  PG_QUERY__NODE__NODE_ROLE_SPEC = 65,
  PG_QUERY__NODE__NODE_FUNC_CALL = 66,
  PG_QUERY__NODE__NODE_A_STAR = 67,
  PG_QUERY__NODE__NODE_A_INDICES = 68,
  PG_QUERY__NODE__NODE_A_INDIRECTION = 69,
  PG_QUERY__NODE__NODE_A_ARRAY_EXPR = 70,
  PG_QUERY__NODE__NODE_RES_TARGET = 71,
  PG_QUERY__NODE__NODE_MULTI_ASSIGN_REF = 72,
  PG_QUERY__NODE__NODE_SORT_BY = 73,
  PG_QUERY__NODE__NODE_WINDOW_DEF = 74,
  PG_QUERY__NODE__NODE_RANGE_SUBSELECT = 75,
  PG_QUERY__NODE__NODE_RANGE_FUNCTION = 76,
  PG_QUERY__NODE__NODE_RANGE_TABLE_FUNC = 77,
  PG_QUERY__NODE__NODE_RANGE_TABLE_FUNC_COL = 78,
  PG_QUERY__NODE__NODE_RANGE_TABLE_SAMPLE = 79,
  PG_QUERY__NODE__NODE_COLUMN_DEF = 80,
  PG_QUERY__NODE__NODE_TABLE_LIKE_CLAUSE = 81,
  PG_QUERY__NODE__NODE_INDEX_ELEM = 82,
  PG_QUERY__NODE__NODE_DEF_ELEM = 83,
  PG_QUERY__NODE__NODE_LOCKING_CLAUSE = 84,
  PG_QUERY__NODE__NODE_XML_SERIALIZE = 85,
  PG_QUERY__NODE__NODE_PARTITION_ELEM = 86,
  PG_QUERY__NODE__NODE_PARTITION_BY = 87,
  PG_QUERY__NODE__NODE_PARTITION_SPEC = 88,
  PG_QUERY__NODE__NODE_PARTITION_BOUND_SPEC = 89,
  PG_QUERY__NODE__NODE_PARTITION_RANGE_DATUM = 90,
  PG_QUERY__NODE__NODE_PARTITION_CMD = 91,
  PG_QUERY__NODE__NODE_RANGE_TBL_ENTRY = 92,
  PG_QUERY__NODE__NODE_RTEPERMISSION_INFO = 93,
  PG_QUERY__NODE__NODE_RANGE_TBL_FUNCTION = 94,
  PG_QUERY__NODE__NODE_TABLE_SAMPLE_CLAUSE = 95,
  PG_QUERY__NODE__NODE_WITH_CHECK_OPTION = 96,
  PG_QUERY__NODE__NODE_SORT_GROUP_CLAUSE = 97,
  PG_QUERY__NODE__NODE_GROUPING_SET = 98,
  PG_QUERY__NODE__NODE_WINDOW_CLAUSE = 99,
  PG_QUERY__NODE__NODE_ROW_MARK_CLAUSE = 100,
  PG_QUERY__NODE__NODE_WITH_CLAUSE = 101,
  PG_QUERY__NODE__NODE_INFER_CLAUSE = 102,
  PG_QUERY__NODE__NODE_ON_CONFLICT_CLAUSE = 103,
  PG_QUERY__NODE__NODE_CTESEARCH_CLAUSE = 104,
  PG_QUERY__NODE__NODE_CTECYCLE_CLAUSE = 105,
  PG_QUERY__NODE__NODE_COMMON_TABLE_EXPR = 106,
  PG_QUERY__NODE__NODE_MERGE_WHEN_CLAUSE = 107,
  PG_QUERY__NODE__NODE_MERGE_ACTION = 108,
  PG_QUERY__NODE__NODE_TRIGGER_TRANSITION = 109,
  PG_QUERY__NODE__NODE_JSON_OUTPUT = 110,
  PG_QUERY__NODE__NODE_JSON_KEY_VALUE = 111,
  PG_QUERY__NODE__NODE_JSON_OBJECT_CONSTRUCTOR = 112,
  PG_QUERY__NODE__NODE_JSON_ARRAY_CONSTRUCTOR = 113,
  PG_QUERY__NODE__NODE_JSON_ARRAY_QUERY_CONSTRUCTOR = 114,
  PG_QUERY__NODE__NODE_JSON_AGG_CONSTRUCTOR = 115,
  PG_QUERY__NODE__NODE_JSON_OBJECT_AGG = 116,
  PG_QUERY__NODE__NODE_JSON_ARRAY_AGG = 117,
  PG_QUERY__NODE__NODE_RAW_STMT = 118,
  PG_QUERY__NODE__NODE_INSERT_STMT = 119,
  PG_QUERY__NODE__NODE_DELETE_STMT = 120,
  PG_QUERY__NODE__NODE_UPDATE_STMT = 121,
  PG_QUERY__NODE__NODE_MERGE_STMT = 122,
  PG_QUERY__NODE__NODE_SELECT_STMT = 123,
  PG_QUERY__NODE__NODE_SET_OPERATION_STMT = 124,
  PG_QUERY__NODE__NODE_RETURN_STMT = 125,
  PG_QUERY__NODE__NODE_PLASSIGN_STMT = 126,
  PG_QUERY__NODE__NODE_CREATE_SCHEMA_STMT = 127,
  PG_QUERY__NODE__NODE_ALTER_TABLE_STMT = 128,
  PG_QUERY__NODE__NODE_REPLICA_IDENTITY_STMT = 129,
  PG_QUERY__NODE__NODE_ALTER_TABLE_CMD = 130,
  PG_QUERY__NODE__NODE_ALTER_COLLATION_STMT = 131,
  PG_QUERY__NODE__NODE_ALTER_DOMAIN_STMT = 132,
  PG_QUERY__NODE__NODE_GRANT_STMT = 133,
  PG_QUERY__NODE__NODE_OBJECT_WITH_ARGS = 134,
  PG_QUERY__NODE__NODE_ACCESS_PRIV = 135,
  PG_QUERY__NODE__NODE_GRANT_ROLE_STMT = 136,
  PG_QUERY__NODE__NODE_ALTER_DEFAULT_PRIVILEGES_STMT = 137,
  PG_QUERY__NODE__NODE_COPY_STMT = 138,
  PG_QUERY__NODE__NODE_VARIABLE_SET_STMT = 139,
  PG_QUERY__NODE__NODE_VARIABLE_SHOW_STMT = 140,
  PG_QUERY__NODE__NODE_CREATE_STMT = 141,
  PG_QUERY__NODE__NODE_CONSTRAINT = 142,
  PG_QUERY__NODE__NODE_CREATE_TABLE_SPACE_STMT = 143,
  PG_QUERY__NODE__NODE_DROP_TABLE_SPACE_STMT = 144,
  PG_QUERY__NODE__NODE_ALTER_TABLE_SPACE_OPTIONS_STMT = 145,
  PG_QUERY__NODE__NODE_ALTER_TABLE_MOVE_ALL_STMT = 146,
  PG_QUERY__NODE__NODE_CREATE_EXTENSION_STMT = 147,
  PG_QUERY__NODE__NODE_ALTER_EXTENSION_STMT = 148,
  PG_QUERY__NODE__NODE_ALTER_EXTENSION_CONTENTS_STMT = 149,
  PG_QUERY__NODE__NODE_CREATE_FDW_STMT = 150,
  PG_QUERY__NODE__NODE_ALTER_FDW_STMT = 151,
  PG_QUERY__NODE__NODE_CREATE_FOREIGN_SERVER_STMT = 152,
  PG_QUERY__NODE__NODE_ALTER_FOREIGN_SERVER_STMT = 153,
  PG_QUERY__NODE__NODE_CREATE_FOREIGN_TABLE_STMT = 154,
  PG_QUERY__NODE__NODE_CREATE_USER_MAPPING_STMT = 155,
  PG_QUERY__NODE__NODE_ALTER_USER_MAPPING_STMT = 156,
  PG_QUERY__NODE__NODE_DROP_USER_MAPPING_STMT = 157,
  PG_QUERY__NODE__NODE_IMPORT_FOREIGN_SCHEMA_STMT = 158,
  PG_QUERY__NODE__NODE_CREATE_POLICY_STMT = 159,
  PG_QUERY__NODE__NODE_ALTER_POLICY_STMT = 160,
  PG_QUERY__NODE__NODE_CREATE_AM_STMT = 161,
  PG_QUERY__NODE__NODE_CREATE_TRIG_STMT = 162,
  PG_QUERY__NODE__NODE_CREATE_EVENT_TRIG_STMT = 163,
  PG_QUERY__NODE__NODE_ALTER_EVENT_TRIG_STMT = 164,
  PG_QUERY__NODE__NODE_CREATE_PLANG_STMT = 165,
  PG_QUERY__NODE__NODE_CREATE_ROLE_STMT = 166,
  PG_QUERY__NODE__NODE_ALTER_ROLE_STMT = 167,
  PG_QUERY__NODE__NODE_ALTER_ROLE_SET_STMT = 168,
  PG_QUERY__NODE__NODE_DROP_ROLE_STMT = 169,
  PG_QUERY__NODE__NODE_CREATE_SEQ_STMT = 170,
  PG_QUERY__NODE__NODE_ALTER_SEQ_STMT = 171,
  PG_QUERY__NODE__NODE_DEFINE_STMT = 172,
  PG_QUERY__NODE__NODE_CREATE_DOMAIN_STMT = 173,
  PG_QUERY__NODE__NODE_CREATE_OP_CLASS_STMT = 174,
  PG_QUERY__NODE__NODE_CREATE_OP_CLASS_ITEM = 175,
  PG_QUERY__NODE__NODE_CREATE_OP_FAMILY_STMT = 176,
  PG_QUERY__NODE__NODE_ALTER_OP_FAMILY_STMT = 177,
  PG_QUERY__NODE__NODE_DROP_STMT = 178,
  PG_QUERY__NODE__NODE_TRUNCATE_STMT = 179,
  PG_QUERY__NODE__NODE_COMMENT_STMT = 180,
  PG_QUERY__NODE__NODE_SEC_LABEL_STMT = 181,
  PG_QUERY__NODE__NODE_DECLARE_CURSOR_STMT = 182,
  PG_QUERY__NODE__NODE_CLOSE_PORTAL_STMT = 183,
  PG_QUERY__NODE__NODE_FETCH_STMT = 184,
  PG_QUERY__NODE__NODE_INDEX_STMT = 185,
  PG_QUERY__NODE__NODE_CREATE_STATS_STMT = 186,
  PG_QUERY__NODE__NODE_STATS_ELEM = 187,
  PG_QUERY__NODE__NODE_ALTER_STATS_STMT = 188,
  PG_QUERY__NODE__NODE_CREATE_FUNCTION_STMT = 189,
  PG_QUERY__NODE__NODE_FUNCTION_PARAMETER = 190,
  PG_QUERY__NODE__NODE_ALTER_FUNCTION_STMT = 191,
  PG_QUERY__NODE__NODE_DO_STMT = 192,
  PG_QUERY__NODE__NODE_INLINE_CODE_BLOCK = 193,
  PG_QUERY__NODE__NODE_CALL_STMT = 194,
  PG_QUERY__NODE__NODE_CALL_CONTEXT = 195,
  PG_QUERY__NODE__NODE_RENAME_STMT = 196,
  PG_QUERY__NODE__NODE_ALTER_OBJECT_DEPENDS_STMT = 197,
  PG_QUERY__NODE__NODE_ALTER_OBJECT_SCHEMA_STMT = 198,
  PG_QUERY__NODE__NODE_ALTER_OWNER_STMT = 199,
  PG_QUERY__NODE__NODE_ALTER_OPERATOR_STMT = 200,
  PG_QUERY__NODE__NODE_ALTER_TYPE_STMT = 201,
  PG_QUERY__NODE__NODE_RULE_STMT = 202,
  PG_QUERY__NODE__NODE_NOTIFY_STMT = 203,
  PG_QUERY__NODE__NODE_LISTEN_STMT = 204,
  PG_QUERY__NODE__NODE_UNLISTEN_STMT = 205,
  PG_QUERY__NODE__NODE_TRANSACTION_STMT = 206,
  PG_QUERY__NODE__NODE_COMPOSITE_TYPE_STMT = 207,
  PG_QUERY__NODE__NODE_CREATE_ENUM_STMT = 208,
  PG_QUERY__NODE__NODE_CREATE_RANGE_STMT = 209,
  PG_QUERY__NODE__NODE_ALTER_ENUM_STMT = 210,
  PG_QUERY__NODE__NODE_VIEW_STMT = 211,
  PG_QUERY__NODE__NODE_LOAD_STMT = 212,
  PG_QUERY__NODE__NODE_CREATEDB_STMT = 213,
  PG_QUERY__NODE__NODE_ALTER_DATABASE_STMT = 214,
  PG_QUERY__NODE__NODE_ALTER_DATABASE_REFRESH_COLL_STMT = 215,
  PG_QUERY__NODE__NODE_ALTER_DATABASE_SET_STMT = 216,
  PG_QUERY__NODE__NODE_DROPDB_STMT = 217,
  PG_QUERY__NODE__NODE_ALTER_SYSTEM_STMT = 218,
  PG_QUERY__NODE__NODE_CLUSTER_STMT = 219,
  PG_QUERY__NODE__NODE_VACUUM_STMT = 220,
  PG_QUERY__NODE__NODE_VACUUM_RELATION = 221,
  PG_QUERY__NODE__NODE_EXPLAIN_STMT = 222,
  PG_QUERY__NODE__NODE_CREATE_TABLE_AS_STMT = 223,
  PG_QUERY__NODE__NODE_REFRESH_MAT_VIEW_STMT = 224,
  PG_QUERY__NODE__NODE_CHECK_POINT_STMT = 225,
  PG_QUERY__NODE__NODE_DISCARD_STMT = 226,
  PG_QUERY__NODE__NODE_LOCK_STMT = 227,
  PG_QUERY__NODE__NODE_CONSTRAINTS_SET_STMT = 228,
  PG_QUERY__NODE__NODE_REINDEX_STMT = 229,
  PG_QUERY__NODE__NODE_CREATE_CONVERSION_STMT = 230,
  PG_QUERY__NODE__NODE_CREATE_CAST_STMT = 231,
  PG_QUERY__NODE__NODE_CREATE_TRANSFORM_STMT = 232,
  PG_QUERY__NODE__NODE_PREPARE_STMT = 233,
  PG_QUERY__NODE__NODE_EXECUTE_STMT = 234,
  PG_QUERY__NODE__NODE_DEALLOCATE_STMT = 235,
  PG_QUERY__NODE__NODE_DROP_OWNED_STMT = 236,
  PG_QUERY__NODE__NODE_REASSIGN_OWNED_STMT = 237,
  PG_QUERY__NODE__NODE_ALTER_TSDICTIONARY_STMT = 238,
  PG_QUERY__NODE__NODE_ALTER_TSCONFIGURATION_STMT = 239,
  PG_QUERY__NODE__NODE_PUBLICATION_TABLE = 240,
  PG_QUERY__NODE__NODE_PUBLICATION_OBJ_SPEC = 241,
  PG_QUERY__NODE__NODE_CREATE_PUBLICATION_STMT = 242,
  PG_QUERY__NODE__NODE_ALTER_PUBLICATION_STMT = 243,
  PG_QUERY__NODE__NODE_CREATE_SUBSCRIPTION_STMT = 244,
  PG_QUERY__NODE__NODE_ALTER_SUBSCRIPTION_STMT = 245,
  PG_QUERY__NODE__NODE_DROP_SUBSCRIPTION_STMT = 246,
  PG_QUERY__NODE__NODE_INTEGER = 247,
  PG_QUERY__NODE__NODE_FLOAT = 248,
  PG_QUERY__NODE__NODE_BOOLEAN = 249,
  PG_QUERY__NODE__NODE_STRING = 250,
  PG_QUERY__NODE__NODE_BIT_STRING = 251,
  PG_QUERY__NODE__NODE_LIST = 252,
  PG_QUERY__NODE__NODE_INT_LIST = 253,
  PG_QUERY__NODE__NODE_OID_LIST = 254,
  PG_QUERY__NODE__NODE_A_CONST = 255
...
struct  PgQuery__Node
{
  ...
  union {
    ...
    PgQuery__DistributeBy *distribute_by;
    PgQuery__PGXCSubCluster *pgxcsub_cluster;
    ...
    PgQuery__PartitionBy *partition_by;
...
struct  PgQuery__DistributeBy
{
  ProtobufCMessage base;
  PgQuery__DistributionType disttype;
  size_t n_colname;
  PgQuery__Node **colname;
};
#define PG_QUERY__DISTRIBUTE_BY__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__distribute_by__descriptor) \
, PG_QUERY__DISTRIBUTION_TYPE__DISTRIBUTION_TYPE_UNDEFINED, 0,NULL }


struct  PgQuery__PGXCSubCluster
{
  ProtobufCMessage base;
  PgQuery__PGXCSubClusterType clustertype;
  size_t n_members;
  PgQuery__Node **members;
};
#define PG_QUERY__PGXCSUB_CLUSTER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__pgxcsub_cluster__descriptor) \
, PG_QUERY__PGXCSUB_CLUSTER_TYPE__PGXCSUB_CLUSTER_TYPE_UNDEFINED, 0,NULL }
...
struct  PgQuery__PartitionBy
{
  ...
  uint32_t partdatatype;
  PgQuery__Node *startvalue;
  PgQuery__Node *step;
  int32_t interval;
  int32_t n_partitions;
};
#define PG_QUERY__PARTITION_BY__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__partition_by__descriptor) \
, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0, 0, 0, NULL, NULL, 0, 0 }
...
struct  PgQuery__PartitionSpec
{
  ...
  PgQuery__PartitionBy *interval;
  int32_t location;
};
#define PG_QUERY__PARTITION_SPEC__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__partition_spec__descriptor) \
, PG_QUERY__PARTITION_STRATEGY__PARTITION_STRATEGY_UNDEFINED, 0,NULL, NULL, 0 }
...
struct  PgQuery__CreateStmt
{
  ...
  protobuf_c_boolean islocal;
  PgQuery__DistributeBy *distributeby;
  PgQuery__PGXCSubCluster *subcluster;
  protobuf_c_boolean interval_child;
  int32_t interval_child_idx;
  uint32_t interval_parent_id;
};
#define PG_QUERY__CREATE_STMT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&pg_query__create_stmt__descriptor) \
, NULL, 0,NULL, 0,NULL, NULL, NULL, NULL, 0,NULL, 0,NULL, PG_QUERY__ON_COMMIT_ACTION__ON_COMMIT_ACTION_UNDEFINED, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0, PG_QUERY__OBJECT_TYPE__OBJECT_TYPE_UNDEFINED, 0, NULL, NULL, 0, 0, 0 }
...
void   pg_query__from_expr__free_unpacked
                     (PgQuery__FromExpr *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__DistributeBy methods */
void   pg_query__distribute_by__init
                     (PgQuery__DistributeBy         *message);
size_t pg_query__distribute_by__get_packed_size
                     (const PgQuery__DistributeBy   *message);
size_t pg_query__distribute_by__pack
                     (const PgQuery__DistributeBy   *message,
                      uint8_t             *out);
size_t pg_query__distribute_by__pack_to_buffer
                     (const PgQuery__DistributeBy   *message,
                      ProtobufCBuffer     *buffer);
PgQuery__DistributeBy *
       pg_query__distribute_by__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data);
void   pg_query__distribute_by__free_unpacked
                     (PgQuery__DistributeBy *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PGXCSubCluster methods */
void   pg_query__pgxcsub_cluster__init
                     (PgQuery__PGXCSubCluster         *message);
size_t pg_query__pgxcsub_cluster__get_packed_size
                     (const PgQuery__PGXCSubCluster   *message);
size_t pg_query__pgxcsub_cluster__pack
                     (const PgQuery__PGXCSubCluster   *message,
                      uint8_t             *out);
size_t pg_query__pgxcsub_cluster__pack_to_buffer
                     (const PgQuery__PGXCSubCluster   *message,
                      ProtobufCBuffer     *buffer);
PgQuery__PGXCSubCluster *
       pg_query__pgxcsub_cluster__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data);
void   pg_query__pgxcsub_cluster__free_unpacked
                     (PgQuery__PGXCSubCluster *message,
                      ProtobufCAllocator *allocator);
...
void   pg_query__partition_elem__free_unpacked
                     (PgQuery__PartitionElem *message,
                      ProtobufCAllocator *allocator);
/* PgQuery__PartitionBy methods */
void   pg_query__partition_by__init
                     (PgQuery__PartitionBy         *message);
size_t pg_query__partition_by__get_packed_size
                     (const PgQuery__PartitionBy   *message);
size_t pg_query__partition_by__pack
                     (const PgQuery__PartitionBy   *message,
                      uint8_t             *out);
size_t pg_query__partition_by__pack_to_buffer
                     (const PgQuery__PartitionBy   *message,
                      ProtobufCBuffer     *buffer);
PgQuery__PartitionBy *
       pg_query__partition_by__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data);
void   pg_query__partition_by__free_unpacked
                     (PgQuery__PartitionBy *message,
                      ProtobufCAllocator *allocator);
...
typedef void (*PgQuery__FromExpr_Closure)
                 (const PgQuery__FromExpr *message,
                  void *closure_data);
typedef void (*PgQuery__DistributeBy_Closure)
                 (const PgQuery__DistributeBy *message,
                  void *closure_data);
typedef void (*PgQuery__PGXCSubCluster_Closure)
                 (const PgQuery__PGXCSubCluster *message,
                  void *closure_data);
...
typedef void (*PgQuery__PartitionElem_Closure)
                 (const PgQuery__PartitionElem *message,
                  void *closure_data);
typedef void (*PgQuery__PartitionBy_Closure)
                 (const PgQuery__PartitionBy *message,
                  void *closure_data);
...
extern const ProtobufCEnumDescriptor    pg_query__distribution_type__descriptor;
extern const ProtobufCEnumDescriptor    pg_query__pgxcsub_cluster_type__descriptor;
...
extern const ProtobufCMessageDescriptor pg_query__distribute_by__descriptor;
extern const ProtobufCMessageDescriptor pg_query__pgxcsub_cluster__descriptor;
...
extern const ProtobufCMessageDescriptor pg_query__partition_by__descriptor;
