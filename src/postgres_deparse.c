...
static void deparseJsonParseExpr(StringInfo str, JsonParseExpr *json_parse_expr)
{
	...
	deparseJsonValueExpr(str, jsonParseExpr->expr);

	if (jsonParseExpr->unique_keys)
...
static void deparseJsonSerializeExpr(StringInfo str, JsonSerializeExpr *json_serialize_expr)
{
	...
	deparseJsonValueExpr(str, jsonSerializeExpr->expr);

	if (jsonSerializeExpr->output)
		deparseJsonOutput(str, jsonSerializeExpr->output);
