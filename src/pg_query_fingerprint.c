...
PgQueryFingerprintResult pg_query_fingerprint_with_opts(const char* input, PgQueryParseMode mode, bool printTokens)
{
...
{
	return pg_query_fingerprint_with_opts(input, mode, false);
}
